...
namespace SignalRWindowsService
{
    ...
    {
        private string _pluginsPath = ConfigurationManager.AppSettings["PluginsPath"];
        private string _connectionString = string.Format("Data Source={0};Version=3;", ConfigurationManager.AppSettings["DatabasePath"]);
        ...
        public void CreateDbFile()
        {
            ...
            //string fileName = "D:\\Monitoring\\MonitoringServerDB.sqlite";
        ...
        public void InitPlugins()
        {
            ...
            //string path = "D:\\Monitoring\\Plugins";

            loader.Load(_pluginsPath);
